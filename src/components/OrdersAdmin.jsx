    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
        ...
        <div className="bg-blue-800 text-white p-8 text-center">
          ...
          <p className="text-xl text-blue-200">Manage and oversee all customer orders in a sleek interface.</p>
        </div>
        ...
        <div className="p-8 space-y-6">
          {/* Orders List Section */}
          <section>
            <h2 className="text-3xl font-semibold text-gray-800 mb-4 border-b-4 border-blue-600 pb-2">
              Recent Orders
            </h2>
          ...
          <section className="flex justify-between items-center mt-8">
            ...
            <div>
              <Link
                to="/archived-orders"
                className="inline-block text-blue-600 font-semibold hover:text-blue-700 transition duration-300 mr-6"
              >
                Archived Orders
              </Link>
              <Link
