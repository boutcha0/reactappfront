    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
        ...
        <div className="bg-yellow-800 text-white p-8 text-center">
          <h1 className="text-4xl font-bold mb-4">Skylark E-Commerce Platform</h1>
        ...
        <div className="p-8 space-y-6">
          ...
          <section>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <span className="bg-gray-100 text-gray-800 px-4 py-2 rounded-full">React</span>
              <span className="bg-gray-100 text-gray-800 px-4 py-2 rounded-full">React Router</span>
              <span className="bg-gray-100 text-gray-800 px-4 py-2 rounded-full">Tailwind CSS</span>
              <span className="bg-gray-100 text-gray-800 px-4 py-2 rounded-full">Axios</span>
            </div>
          </section>
          ...
          <section className="text-center mt-8">
            <Link 
              to="/login"
              className="inline-block bg-yellow-800 text-white px-8 py-3 rounded-lg hover:bg-yellow-900 transition duration-300 text-lg font-semibold"
            >
              Start Shopping Now
            </Link>
          </section>
